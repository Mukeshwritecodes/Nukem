    ...
    <nav className="flex flex-col items-start gap-3 w-full">
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex items-center gap-7 max-md:hidden">
          ...
          <button className="w-[173px] h-[52px] relative flex items-center justify-center cursor-pointer rounded-lg border-[1.6px] border-solid border-[#0FA4AF] hover:bg-[#0FA4AF] hover:text-white transition-all duration-200 max-lg:w-[150px] max-lg:h-[48px] text-[#0FA4AF] text-base font-normal max-lg:text-sm" onClick={onCustomizeWipe}>
            Get Started
          </button>
        </div>
