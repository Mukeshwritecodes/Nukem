      ...
      <footer id="contacts" className="w-full bg-[#356D73] text-white">
        <div className="flex flex-col items-center gap-8 w-full px-12 py-16 max-md:px-6 max-md:py-12 max-sm:px-5 max-sm:py-8">
          <div className="flex flex-col items-center gap-6 max-w-4xl w-full">
            <h3 className="text-3xl font-bold text-center max-md:text-2xl max-sm:text-xl">Contact Us</h3>
            <p className="text-lg text-center text-gray-300 max-md:text-base max-sm:text-sm">Have questions about secure data wiping? We're here to help.</p>
          </div>

          <div className="flex flex-wrap justify-center gap-8 max-md:gap-6 max-sm:flex-col max-sm:gap-4">
            <div className="flex flex-col items-center gap-2">
              <h4 className="font-semibold text-[#AFDDE5]">Email</h4>
              <p className="text-gray-300">support@securewipe.com</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <h4 className="font-semibold text-[#AFDDE5]">Documentation</h4>
              <p className="text-gray-300">View our complete guides</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <h4 className="font-semibold text-[#AFDDE5]">Security</h4>
          ...
          <div className="flex flex-col items-center gap-4 text-sm text-gray-300">
